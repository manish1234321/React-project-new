 ...
 const slideBackward = ()=>{
  ...
  return (
    <div className='testimonials'>
        <img src={next_icon} alt="next button image" className='next-btn' onClick={slideForward}/>
        <img src={back_icon} alt="back button image" className='back-btn' onClick={slideBackward}/>
